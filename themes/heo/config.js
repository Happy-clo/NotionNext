const CONFIG = {
  ...
  HEO_NOTICE_BAR: [
    { title: '欢迎来到HAPPYA.TOP', url: 'https://happya.top' }
  ],

  // 英雄区(首页顶部大卡)
  HEO_HERO_TITLE_1: 'AI纪元',
  HEO_HERO_TITLE_2: '与服务器',
  HEO_HERO_TITLE_3: 'HAPPYA.TOP',
  HEO_HERO_TITLE_4: '最新发布',
  HEO_HERO_TITLE_5: '👏欢迎来到这里',
  HEO_HERO_TITLE_LINK: 'https://happya.top',
  ...
  HEO_INFO_CARD_URL: 'https://github.com/Happy-clo', // 个人资料底部按钮链接
  ...
  HEO_SOCIAL_CARD_URL: 'https://discord.gg/WubD8gwp',
